...
public class MainActivity extends Activity {
	...
	public final static int SETCURRENT_NETWORKLESS_STATUE   = 0x400 + 19;
		...
		handler = new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				case HANDLE_WELCOME_FRAGMENT_DISMISS:
					if(welcomeFragment != null && handFragment != null){
					...
					if (info_wifi != null && info_wifi.isConnected()) {
						if (info_wifi.getType() == ConnectivityManager.TYPE_WIFI) {
							...
							handler.postDelayed(new Runnable() {
								...
								public void run() {
									// TODO Auto-generated method stub
									if(!networkWirelessFragment.isTextView_open_wifiVisible() )
										handler.obtainMessage(MainActivity.HANDLE_NETWORK_WIRELESS_DISMISS).sendToTarget();
								}
							}, 2000);
						}
					}
				...
				case SETCURRENT_NETWORKLESS_STATUE:
					currentFragment = networkWirelessFragment;
					break;
				...
				case HANDLE_NETWORK_WIRELESS_DISMISS:
					if(currentFragment == networkWirelessFragment){
	...
	public boolean onKeyDown(int arg0, KeyEvent arg1) {
		// TODO Auto-generated method stub
			...
			if(arg1.getKeyCode() == 97 && currentFragment == networkWirelessFragment && !networkWirelessFragment.isInListview() && getWindow().getAttributes().softInputMode != WindowManager.LayoutParams.SOFT_INPUT_STATE_UNSPECIFIED)
				networkWirelessFragment.inputSecretBack();
			...
			if((arg1.getKeyCode() == 99 || arg1.getKeyCode() == 67) && currentFragment == networkWirelessFragment && networkWirelessFragment.isInListview())
	...
	public boolean isNetworkedFragment(){
		return currentFragment == networkWiredFragment ;
	}
